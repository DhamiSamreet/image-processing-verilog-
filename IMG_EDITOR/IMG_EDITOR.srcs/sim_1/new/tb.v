...
processor obj( clk, reset, sel_module,red, green, blue,     // input signlas
                     done_in, done_out,       // output signals for tgb2gray
                     val,                           // brightness values
                     red_o, green_o, blue_o);
                     
                     
`define picture "/home/2018csb1118/Desktop/IMG_EDITOR/img.bmp"
 localparam len = 750*1600;
 ...
 integer i, j;
 localparam RESULT_ARRAY_LEN = 750*1600;
...
//Image Write Start
 ...
 `define write_filename "/home/2018csb1118/Desktop/IMG_EDITOR/op.bmp"
